...
{
    /// <inheritdoc />
    public partial class shoenew : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0d4a80da-8f17-4c40-a176-4a6612fe15df"), "Cỡ giày 43", "Size 43", true, 43 },
                    { new Guid("14a998a3-d2cd-458c-b521-7035f720babe"), "Cỡ giày 48", "Size 48", true, 48 },
                    { new Guid("1723035c-5077-4946-8242-344ee5d085d0"), "Cỡ giày 41", "Size 41", true, 41 },
                    { new Guid("31b301ea-eb13-4111-98b4-b94629dc2d44"), "Cỡ giày 42", "Size 42", true, 42 },
                    { new Guid("51259680-4f31-4e5a-8df7-f4660712b286"), "Cỡ giày 44", "Size 44", true, 44 },
                    { new Guid("56d9ce14-39d4-45a2-b9e1-7e91d8520e0d"), "Cỡ giày 40", "Size 40", true, 40 },
                    { new Guid("5a58e29b-345b-4e1b-adfc-43f640202d29"), "Cỡ giày 39", "Size 39", true, 39 },
                    { new Guid("5bb98c39-6583-4644-b9fc-f5e498778540"), "Cỡ giày 36", "Size 36", true, 36 },
                    { new Guid("6f3a8757-c487-4456-ba07-1d0297be4d21"), "Cỡ giày 45", "Size 45", true, 45 },
                    { new Guid("7f44958e-6145-4a98-bbd0-13a180d614f4"), "Cỡ giày 46", "Size 46", true, 46 },
                    { new Guid("859993b5-7532-44d3-88c1-3945e58b1ad4"), "Cỡ giày 50", "Size 50", true, 50 },
                    { new Guid("8751db0e-dd63-4ed3-9658-815f067904ac"), "Cỡ giày 35", "Size 35", true, 35 },
                    { new Guid("8e2fd743-c4fe-448e-afa5-f158d0c963b9"), "Cỡ giày 47", "Size 47", true, 47 },
                    { new Guid("9f6729f2-8c0c-40eb-b24c-e6c4f7cec8db"), "Cỡ giày 38", "Size 38", true, 38 },
                    { new Guid("c8b1a95b-3564-40cb-81fd-db65cb5edb39"), "Cỡ giày 49", "Size 49", true, 49 },
                    { new Guid("e3b57727-14e8-4438-8a06-215235272f21"), "Cỡ giày 37", "Size 37", true, 37 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("30edb699-5aba-4275-abe7-b68507946fe6"), "#000000", "Màu đen", "Đen", true },
                    { new Guid("3c93bc06-e876-44ea-ac7f-436344313b59"), "#FFFFFF", "Màu trắng", "Trắng", true },
                    { new Guid("40f212f6-1419-4564-9b78-d132c5f227a7"), "#0000FF", "Màu xanh dương cơ bản", "Xanh dương", true },
                    { new Guid("6095604a-e579-4596-a4bb-54864733a4cc"), "#FFFF00", "Màu vàng", "Vàng", true },
                    { new Guid("a10ee45b-8484-4f69-88d4-f72e8d2d0bb2"), "#FF0000", "Màu đỏ cơ bản", "Đỏ", true },
                    { new Guid("ef5a54d8-d9ea-41b2-aa6a-e1fc97b58724"), "#00FF00", "Màu xanh lá cây", "Xanh lá", true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("99999999-9999-9999-9999-999999999999"), new DateTime(2025, 9, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin123", "admin" },
                    { new Guid("e72b99a1-488f-4f84-b606-0c1bfd797e4b"), new DateTime(2025, 9, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "kh123456", "khachhang1" }
                });

            migrationBuilder.InsertData(
                table: "KhachHangs",
                columns: new[] { "KhachHangId", "Email", "HoTen", "NgayCapNhatCuoiCung", "NgaySinh", "NgayTao", "SoDienThoai", "TaiKhoanId", "TrangThai" },
                values: new object[] { new Guid("8ab710a5-c07a-4907-9a14-86d29e3912d4"), "nguyenvana@email.com", "Nguyen Van A", new DateTime(2025, 9, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1995, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 9, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "0912345678", new Guid("e72b99a1-488f-4f84-b606-0c1bfd797e4b"), true });

            migrationBuilder.InsertData(
                table: "NhanViens",
                columns: new[] { "NhanVienId", "ChucVuId", "Email", "HoTen", "NgayCapNhatCuoiCung", "NgaySinh", "SoDienThoai", "TaikhoanId", "TrangThai" },
                values: new object[] { new Guid("88888888-8888-8888-8888-888888888888"), new Guid("11111111-1111-1111-1111-111111111111"), "admin@shop.com", "Nguyễn Văn Quản Trị", new DateTime(2025, 9, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1995, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "0987654321", new Guid("99999999-9999-9999-9999-999999999999"), true });
