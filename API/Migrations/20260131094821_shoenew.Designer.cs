...
namespace API.Migrations
{
    ...
    [Migration("20260131094821_shoenew")]
    partial class shoenew
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Data.Models.KhachHang", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            KhachHangId = new Guid("8ab710a5-c07a-4907-9a14-86d29e3912d4"),
                            Email = "nguyenvana@email.com",
                            HoTen = "Nguyen Van A",
                            NgayCapNhatCuoiCung = new DateTime(2025, 9, 18, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgaySinh = new DateTime(1995, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayTao = new DateTime(2025, 9, 18, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            SoDienThoai = "0912345678",
                            TaiKhoanId = new Guid("e72b99a1-488f-4f84-b606-0c1bfd797e4b"),
                            TrangThai = true
                        });
                });
            ...
            modelBuilder.Entity("Data.Models.KichCo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            KichCoId = new Guid("8751db0e-dd63-4ed3-9658-815f067904ac"),
                            MoTa = "Cỡ giày 35",
                            TenKichCo = "Size 35",
                            TrangThai = true,
                            size = 35
                        ...
                        new
                        {
                            KichCoId = new Guid("5bb98c39-6583-4644-b9fc-f5e498778540"),
                            MoTa = "Cỡ giày 36",
                            TenKichCo = "Size 36",
                            TrangThai = true,
                            size = 36
                        ...
                        new
                        {
                            KichCoId = new Guid("e3b57727-14e8-4438-8a06-215235272f21"),
                            MoTa = "Cỡ giày 37",
                            TenKichCo = "Size 37",
                            TrangThai = true,
                            size = 37
                        ...
                        new
                        {
                            KichCoId = new Guid("9f6729f2-8c0c-40eb-b24c-e6c4f7cec8db"),
                            MoTa = "Cỡ giày 38",
                            TenKichCo = "Size 38",
                            TrangThai = true,
                            size = 38
                        ...
                        new
                        {
                            KichCoId = new Guid("5a58e29b-345b-4e1b-adfc-43f640202d29"),
                            MoTa = "Cỡ giày 39",
                            TenKichCo = "Size 39",
                            TrangThai = true,
                            size = 39
                        ...
                        new
                        {
                            KichCoId = new Guid("56d9ce14-39d4-45a2-b9e1-7e91d8520e0d"),
                            MoTa = "Cỡ giày 40",
                            TenKichCo = "Size 40",
                            TrangThai = true,
                            size = 40
                        ...
                        new
                        {
                            KichCoId = new Guid("1723035c-5077-4946-8242-344ee5d085d0"),
                            MoTa = "Cỡ giày 41",
                            TenKichCo = "Size 41",
                            TrangThai = true,
                            size = 41
                        ...
                        new
                        {
                            KichCoId = new Guid("31b301ea-eb13-4111-98b4-b94629dc2d44"),
                            MoTa = "Cỡ giày 42",
                            TenKichCo = "Size 42",
                            TrangThai = true,
                            size = 42
                        ...
                        new
                        {
                            KichCoId = new Guid("0d4a80da-8f17-4c40-a176-4a6612fe15df"),
                            MoTa = "Cỡ giày 43",
                            TenKichCo = "Size 43",
                            TrangThai = true,
                            size = 43
                        ...
                        new
                        {
                            KichCoId = new Guid("51259680-4f31-4e5a-8df7-f4660712b286"),
                            MoTa = "Cỡ giày 44",
                            TenKichCo = "Size 44",
                            TrangThai = true,
                            size = 44
                        ...
                        new
                        {
                            KichCoId = new Guid("6f3a8757-c487-4456-ba07-1d0297be4d21"),
                            MoTa = "Cỡ giày 45",
                            TenKichCo = "Size 45",
                            TrangThai = true,
                            size = 45
                        ...
                        new
                        {
                            KichCoId = new Guid("7f44958e-6145-4a98-bbd0-13a180d614f4"),
                            MoTa = "Cỡ giày 46",
                            TenKichCo = "Size 46",
                            TrangThai = true,
                            size = 46
                        ...
                        new
                        {
                            KichCoId = new Guid("8e2fd743-c4fe-448e-afa5-f158d0c963b9"),
                            MoTa = "Cỡ giày 47",
                            TenKichCo = "Size 47",
                            TrangThai = true,
                            size = 47
                        ...
                        new
                        {
                            KichCoId = new Guid("14a998a3-d2cd-458c-b521-7035f720babe"),
                            MoTa = "Cỡ giày 48",
                            TenKichCo = "Size 48",
                            TrangThai = true,
                            size = 48
                        ...
                        new
                        {
                            KichCoId = new Guid("c8b1a95b-3564-40cb-81fd-db65cb5edb39"),
                            MoTa = "Cỡ giày 49",
                            TenKichCo = "Size 49",
                            TrangThai = true,
                            size = 49
                        ...
                        new
                        {
                            KichCoId = new Guid("859993b5-7532-44d3-88c1-3945e58b1ad4"),
                            MoTa = "Cỡ giày 50",
                            TenKichCo = "Size 50",
                            TrangThai = true,
                            size = 50
            ...
            modelBuilder.Entity("Data.Models.MauSac", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MauSacId = new Guid("a10ee45b-8484-4f69-88d4-f72e8d2d0bb2"),
                            Color = "#FF0000",
                            MoTa = "Màu đỏ cơ bản",
                            TenMau = "Đỏ",
                            TrangThai = true
                        ...
                        new
                        {
                            MauSacId = new Guid("40f212f6-1419-4564-9b78-d132c5f227a7"),
                            Color = "#0000FF",
                        ...
                        new
                        {
                            MauSacId = new Guid("ef5a54d8-d9ea-41b2-aa6a-e1fc97b58724"),
                            Color = "#00FF00",
                        ...
                        new
                        {
                            MauSacId = new Guid("6095604a-e579-4596-a4bb-54864733a4cc"),
                            Color = "#FFFF00",
                            MoTa = "Màu vàng",
                            TenMau = "Vàng",
                            TrangThai = true
                        ...
                        new
                        {
                            MauSacId = new Guid("30edb699-5aba-4275-abe7-b68507946fe6"),
                            Color = "#000000",
                            MoTa = "Màu đen",
                            TenMau = "Đen",
                            TrangThai = true
                        ...
                        new
                        {
                            MauSacId = new Guid("3c93bc06-e876-44ea-ac7f-436344313b59"),
                            Color = "#FFFFFF",
                            MoTa = "Màu trắng",
                            TenMau = "Trắng",
                            TrangThai = true
            ...
            modelBuilder.Entity("Data.Models.TaiKhoan", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TaikhoanId = new Guid("99999999-9999-9999-9999-999999999999"),
                            Ngaytaotaikhoan = new DateTime(2025, 9, 18, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Password = "admin123",
                            Username = "admin"
                        },
                        new
